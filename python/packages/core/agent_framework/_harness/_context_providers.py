...
class HarnessGuidanceProvider(ContextProvider):
    ...
    RESPONSE_STYLE_GUIDANCE = (
        ...
        "   - For workspace tasks: 'I'll investigate the workflow engine. Let me start by\n"
        "     exploring the directory structure.'\n"
        "   - For knowledge questions: just answer directly — no tool calls needed.\n"
        "2. Between batches of tool calls, briefly narrate what you found and what you're\n"
        "   doing next. Keep it to 1-2 sentences — avoid restating what you already said.\n"
        ...
        "4. PRESENTING RESULTS: When your investigation is complete, present the actual\n"
        "   content directly in your response text. Do NOT just say 'the results are stored\n"
    ...
    SUB_AGENT_GUIDANCE = (
        ...
        "dispatch parallel explore calls instead of reading them serially. For example, if you\n"
        "found 5 modules to research, call explore 5 times in the SAME turn — each with a\n"
        "specific prompt like 'Read and summarize the key classes and patterns in <path>'. This\n"
        "is faster AND keeps your context lean (you get summaries, not full file contents).\n\n"
