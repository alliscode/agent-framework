...
For an introduction to sub-workflows and the `BindAsExecutor()` API, see the [Sub-Workflows foundational sample](../../../../03-workflows/_start-here/05_SubWorkflows).
...
```bash
cd dotnet/samples/04-hosting/durable-workflows/ConsoleApps/07_SubWorkflows
