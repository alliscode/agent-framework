...
```bash
cd dotnet/samples/04-hosting/durable-agents/ConsoleApps/07_ReliableStreaming
...
| `FOUNDRY_PROJECT_ENDPOINT` | Azure AI Foundry project endpoint URL | (required) |
| `FOUNDRY_MODEL` | Model deployment name | (required) |
