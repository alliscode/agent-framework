...
- [Agent Workflow Patterns](../../_start-here/03_AgentWorkflowPatterns) - Group chat without approvals
- [Human-in-the-Loop Basic](../../human-in-the-loop/HumanInTheLoopBasic) - Workflow-level human interaction
