...
To use Anthropic with Microsoft Foundry, you can check the sample [providers/Agent_With_Anthropic](../providers/Agent_With_Anthropic/README.md) for more details.
