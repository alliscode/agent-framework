...
This sample demonstrates how to use background responses with ChatCompletionAgent and Azure AI Foundry for long-running operations. Background responses support:
