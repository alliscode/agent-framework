...
- **Azure AI Foundry Integration**: Uses Azure AI Foundry LLM agents
...
$env:FOUNDRY_MODEL="gpt-5.4-mini" # Replace with your model deployment name (optional, defaults to gpt-5.4-mini)
```
